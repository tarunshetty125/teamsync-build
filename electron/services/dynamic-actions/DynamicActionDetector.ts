...
// Pattern-based trigger detector for dynamic actions.
// Maps mode-specific regex patterns against live transcript text
// to surface contextual action suggestions.

import type { ActionTrigger, TriggerMatch } from './DynamicAction';

/* ═══════════════════════════════════════════════════════════
   Mode-specific trigger definitions
   ═══════════════════════════════════════════════════════════ */
...
const SALES_TRIGGERS: ActionTrigger[] = [
  ...
  },
  {
    ...
    promptInstruction:
      'You are in Sales mode. The prospect mentioned a competitor. Position advantages confidently without disparaging the competitor.',
...
export class DynamicActionDetector {
  ...
  /** Scan transcript text for matching triggers in the given mode. */
  ...
  /** Look up a trigger definition by its type string across all modes. */
