...
const V2_SIGNAL_RULES: SignalRule[] = [
    ...
    { category: 'system_design', signal: 'system.design_prompt', weight: 3.2, pattern: /\bdesign\s+(?:(?:a|an|the)\s+)?(?:whatsapp|watsapp|instagram|instgram|twitter|youtube|uber|flipkart|flipkrat|flipcart|amazon|shopify|e-?commerce|marketplace|payment|checkout|notification|chat|feed|service|system|platform|api|messaging|url shortener|rate limiter|search engine|recommendation|file storage)\b/i },
    { category: 'system_design', signal: 'system.hld_lld', weight: 3.3, pattern: /\b(?:hld|lld|llf|high[\s-]?level design|low[\s-]?level design)\s+(?:for|of)?\s*(?:whatsapp|watsapp|instagram|instgram|twitter|youtube|uber|flipkart|flipkrat|flipcart|amazon|shopify|e-?commerce|marketplace|payment|checkout|chat|notification|system|backend|platform|service|app)?\b/i },
    ...
    { category: 'system_design', signal: 'system.architecture', weight: 2.7, pattern: /\b(system design|architecture|distributed|microservices|event driven|pub\/sub|real[\s-]?time system|real[\s-]?time chat)\b/i },
    ...
    { category: 'system_design', signal: 'system.product', weight: 2.2, pattern: /\b(whatsapp|watsapp|instagram|instgram|twitter|youtube|uber|flipkart|flipkrat|flipcart|amazon|shopify|netflix|netflx|swiggy|zomato|paytm|stripe|dropbox|google drive|slack|discord)\b/i },
