...
export class TeamMeetingBrain implements Brain {
    ...
    /**
     * Run team-meeting sub-brains synchronously and append high-confidence insights.
     * Capability-gated, failure-safe, prompt-bloat-safe.
     */
    private appendSubBrainInsights(input: BrainInput, output: BrainOutput): BrainOutput {
        return runSubBrains('team_meeting', input, output, 'multi_brain_team_meeting', 'MULTI-BRAIN TEAM MEETING INSIGHTS', 'TeamMeetingBrain');
    }
}
