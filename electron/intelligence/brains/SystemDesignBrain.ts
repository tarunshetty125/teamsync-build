        ...
        if (isShort) {
            ...
            instructions.push({
                ...
                content: [
                    ...
                    '6. Include a fenced ```architecture_json``` block with diagram.type="architecture", direction, nodes, and edges.',
                    '',
            ...
            instructions.push({
                ...
                content: [
                    ...
                    'The architecture_json must be valid JSON only: {"diagram":{"type":"architecture","direction":"TB","nodes":[{"id":"gateway","label":"API Gateway","kind":"gateway"}],"edges":[{"source":"gateway","target":"service","label":"routes"}]}}.',
                    'Allowed node kinds: client, gateway, service, database, cache, queue, storage, external.',
                    'Allowed edge fields: source, target, label.',
