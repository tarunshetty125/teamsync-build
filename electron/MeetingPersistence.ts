...
Return ONLY valid JSON (no markdown code blocks):
{
  ...
  "actionItems": ["specific next steps, assigned tasks, or implied follow-ups. If absolutely none found, return empty array"]
                ...
                if (generatedSummary) {
                    ...
                    console.log(`[MeetingPersistence] Raw LLM summary response length=${jsonStr.length} redacted=true`);
                    try {
                        ...
                        console.error(`[MeetingPersistence] Failed to parse summary JSON. responseLength=${jsonStr.length} redacted=true`, e);
                    }
                }
            } else {
