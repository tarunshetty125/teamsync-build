...
const GoogleSignIn: React.FC<GoogleSignInProps> = ({ onSignInComplete }) => {
  ...
  // ─────────────────────────────────────────────
  // Sign-in button & Page Spotlight animation
  // ─────────────────────────────────────────────
      ...
      <AnimatePresence>
        {showContent && (
          <motion.div
            ...
            initial="hidden"
            animate="visible"
            className="relative z-10 flex flex-col items-center max-w-[420px] w-full px-8 py-12 border border-white/[0.08] rounded-[32px] bg-white/[0.02] backdrop-blur-sm shadow-2xl"
          >
            {/* App Icon with Glow */}
            ...
            <motion.p
              variants={itemVariants}
              className="text-[15px] font-sans text-[#b0b7c3] text-center mb-10 leading-relaxed max-w-[320px]"
            >
              ...
              <AnimatePresence mode="wait">
                {state === 'idle' || state === 'error' ? (
                  ...
                  >
                    ...
                    <GoogleLogo />
                    <span className="relative z-20 font-sans font-medium text-[#e5e7eb] group-hover:text-white transition-colors">
