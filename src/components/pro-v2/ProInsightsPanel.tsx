        ...
        >
            ...
            <div className="v2-panel-header">
                ...
                <div className="v2-panel-actions">
                    <button
                        className={`v2-panel-btn ${showTranscript ? 'v2-panel-btn--active-accent' : ''}`}
                        onClick={onToggleTranscript}
                        data-tooltip={showTranscript ? 'Hide transcript' : 'Show transcript'}
                    >
                        {showTranscript ? (
                    ...
                    <button
                        ...
                        onClick={handleCopy}
                        data-tooltip={copiedText ? 'Copied!' : 'Copy transcript'}
                    >
                        {copiedText ? (
